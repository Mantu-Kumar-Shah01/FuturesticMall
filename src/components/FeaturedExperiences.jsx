...
const EXPERIENCES = [
  {
    id: 'shop',
    title: 'SHOP',
    subtitle: 'Discover global brands.',
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {EXPERIENCES.map((exp) => (
            <div
              key={exp.id}
              className="group relative h-80 rounded-2xl overflow-hidden glass-panel border border-slate-800 hover:border-blue-500/60 transition-all duration-300 cursor-pointer flex flex-col justify-end p-6"
            >
              {/* Image */}
              <img
                src={exp.image}
              ...
              <div className="relative z-10 space-y-1">
                <h3 className="font-editorial text-3xl font-extrabold text-white tracking-wide uppercase group-hover:text-blue-400 transition-colors">
                  {exp.title}
                </h3>
              ...
              <div className="absolute bottom-6 right-6 w-8 h-8 rounded-full border border-slate-700 glass-panel flex items-center justify-center text-slate-300 group-hover:border-blue-400 group-hover:text-blue-400 transition-all">
