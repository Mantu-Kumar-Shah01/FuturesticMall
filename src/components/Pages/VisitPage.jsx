    ...
    <div className="min-h-screen pt-28 pb-20 bg-[#04060b] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 space-y-10 w-full">
        ...
        <div className="space-y-2 max-w-2xl">
          ...
          <h1 className="font-editorial text-2xl sm:text-4xl lg:text-5xl font-extrabold uppercase tracking-tight leading-tight break-words">WE ARE HERE <span className="text-[#19A7FF]">FOR YOU.</span></h1>
