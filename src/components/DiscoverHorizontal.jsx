...
export default function DiscoverHorizontal() {
  ...
  return (
    <section id="discover" className="py-24 bg-[#04060b] relative border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-6 md:px-10 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h2 className="font-editorial text-4xl sm:text-5xl font-extrabold text-white uppercase tracking-tight leading-tight">
            MORE THAN A MALL. <br />
            <span className="text-blue-500">A DESTINATION.</span>
          </h2>
        </div>
        ...
        <div className="flex flex-col items-start md:items-end space-y-4 max-w-sm">
          ...
          <button className="inline-flex items-center space-x-2 text-xs font-mono text-slate-200 hover:text-blue-400 transition-colors uppercase">
      ...
      {/* Horizontal Carousel Container - Aligned to max-w-7xl mx-auto */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 mb-4">
        ...
        >
          {CATEGORIES.map((cat) => (
            <div
              key={cat.number}
              className="snap-start flex-none w-[260px] sm:w-[310px] lg:w-[320px] group relative rounded-2xl overflow-hidden glass-panel border border-slate-800 hover:border-blue-500/50 transition-all duration-500 cursor-pointer"
            >
              {/* Card Image */}
              <div className="h-[280px] sm:h-[340px] w-full overflow-hidden relative bg-slate-900">
                ...
                <div className="absolute bottom-6 left-6 right-6 space-y-1">
                  ...
                  <h3 className="font-editorial text-2xl font-bold text-white tracking-wide uppercase group-hover:text-blue-400 transition-colors">
                    {cat.title}
                  </h3>
                </div>
              </div>
