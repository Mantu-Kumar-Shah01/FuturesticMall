...
const SPATIAL_ZONES = [
  {
    ...
    color: 'bg-[#19A7FF]',
    image: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=400&q=70',
    desc: 'Haute Couture & International Flagships',
  },
  {
    id: 'dining',
    name: 'DINING',
    ...
    pos: 'top-32 right-12',
    color: 'bg-amber-400',
    image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=400&q=70',
    desc: 'Michelin-Star Culinary & Sky Lounges',
  },
  {
    id: 'lifestyle',
    name: 'LIFESTYLE',
    ...
    image: 'https://images.unsplash.com/photo-1508974239320-0a029497e820?auto=format&fit=crop&w=400&q=70',
    desc: 'Automobili Showcase & Fine Art Gallery',
  },
  {
    id: 'entertainment',
    name: 'ENTERTAINMENT',
    ...
    color: 'bg-purple-500',
    image: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=400&q=70',
    desc: '4K Laser IMAX Dome & VR Arena',
  },
];

export default function HeroSection({ onOpenStoreDirectory }) {
  const [activeZone, setActiveZone] = useState(null);

  return (
    <section className="relative min-h-screen pt-28 pb-16 flex items-center justify-center overflow-hidden bg-[#04060b]">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center space-y-6 text-left">
          <motion.div
            ...
            className="space-y-1"
          >
            <h1 className="font-editorial text-5xl sm:text-6xl xl:text-7xl font-extrabold tracking-tight text-white uppercase leading-[0.98]">
              THE FUTURE <br />
              OF <br />
              <span className="text-[#19A7FF]">SHOPPING.</span>
            </h1>
          </motion.div>
          ...
          >
            <a
              href="#discover"
              className="group inline-flex items-center space-x-2.5 px-7 py-4 rounded-xl bg-[#19A7FF] hover:bg-[#19A7FF]/90 text-white font-bold text-xs tracking-[0.2em] uppercase transition-all duration-300 shadow-[0_0_30px_rgba(25,167,255,0.5)]"
            >
            ...
            <button
              ...
              className="px-7 py-4 rounded-xl glass-panel text-slate-200 hover:text-white border border-slate-700 hover:border-slate-500 text-xs font-mono tracking-widest uppercase transition-all"
            >
              VIEW STORES
            </button>
          </motion.div>
        ...
        {/* Right Column 60%: Floating Zone Icons & Floating Image Previews */}
        <div className="lg:col-span-6 h-[440px] lg:h-[540px] relative pointer-events-none">
      ...
      <motion.a
        ...
        className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-1 text-slate-400 hover:text-[#19A7FF] transition-colors z-20"
      >
